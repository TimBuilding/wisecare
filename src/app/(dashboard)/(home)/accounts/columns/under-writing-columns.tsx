...
const underWritingColumns: ColumnDef<getAccountsResponse>[] = [
  {
    accessorKey: 'company_name',
    header: ({ column }) => {
      return <TableHeader column={column} title="Company Name" />
    },
  },
  {
    accessorKey: 'agent.first_name',
    header: ({ column }) => {
      return <TableHeader column={column} title="Agent Name" />
    },
  },
  {
...
export default underWritingColumns
