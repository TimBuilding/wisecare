...
const ApproveRequestButton: FC<ApproveRequestButtonProps> = ({ children }) => {
  ...
  const handleClick = async () => {
    ...
    await insertAccount([
      {
        ...
        previous_hmo_provider_id: (selectedData as any).previous_hmo_provider
          .id,
        current_hmo_provider_id: (selectedData as any).current_hmo_provider.id,
    ...
    if (isInsertAccountError) throw new Error('Error updating pending account')
  ...
  }, [isInsertingAccount, isUpdatingPendingAccount])
